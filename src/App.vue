...
<template>
  <div class="flex flex-col items-center gap-2 w-full h-screen justify-center bg-black">
    <h2 class="text-yellow-400">Input some values you will see the changes</h2>
